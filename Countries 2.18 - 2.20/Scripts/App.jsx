...
const App = () => {
  ...
  const fetchWeatherData =async (capital) => {
    try{
      ...
      //const v3=`https://api.openweathermap.org/data/3.0/weather?q=${capital}&appid=${apiKey}&units=metric`
      ...
      {countries.length > 10 && (
        ...
        {selectedCountry && (
            <div>
              ...
              <p>Language(s): 
                {selectedCountry.languages && renderLanguage(selectedCountry.languages)}</p>
              <p>Flag:</p>
              {
                <img 
      ...
      {countries.length===1 && (
            <div>
              ...
              <p>Language(s): 
                ...
                renderLanguage(countries[0].languages)}</p>
              <p>Flag:</p>
              {
                <img 
